...
icon = Image.open("C:/Users/user/Desktop/airbnb_logo_detail.jpg")
...
client = pymongo.MongoClient("mongodb+srv://Mariyasuriya:Guvi2024@cluster0.q97tvf6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client.sample_airbnb
col = db.listingsAndReviews

# READING THE CLEANED DATAFRAME
df = pd.read_csv('D:/Suriya/Datascience/Airbnb_data.csv')

# HOME PAGE
if selected == "Home":
    # Title Image
    st.image("C:/Users/user/Desktop/airbnb_logo_detail.jpg")
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("C:/Users/user/Desktop/airbnb_logo_detail.jpg")
